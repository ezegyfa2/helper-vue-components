...
export default {
    install(Vue) {
        ...
        Vue.config.optionMergeStrategies.data = function strategy(
            ...
            if (
                ...
                return function () {
                    ...
                    let data = mergedData();
                    if (
                        'addedClasses' in originalData &&
                        'addedClasses' in newData
                    ) {
        ...
        registerVueComponent(
            ...
            require('./Form/FormItemsWithoutLabel/FormItemWithValidationErrors/Component.vue').default,
            Vue,
        ...
        registerVueComponent(
            ...
            require('./Pagintation/BootstrapPagination/Pagination/Component.vue').default,
            Vue,
        ...
        Vue.component(
            'VSelect',
            require('./Form/VSelect/Component.vue').default
        );
